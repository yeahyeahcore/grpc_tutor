...
func (x *GetLocationRequest) GetCourierId() int32 {
	if x != nil {
		return x.CourierId
	}
	return 0
...
type GetLocationResponse_Location struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetLocationResponse_Location) Reset() {
	*x = GetLocationResponse_Location{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLocationResponse_Location) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLocationResponse_Location) ProtoMessage() {}

func (x *GetLocationResponse_Location) ProtoReflect() protoreflect.Message {
	mi := &file_proto_location_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLocationResponse_Location.ProtoReflect.Descriptor instead.
func (*GetLocationResponse_Location) Descriptor() ([]byte, []int) {
	return file_proto_location_proto_rawDescGZIP(), []int{1, 0}
}

func (x *GetLocationResponse_Location) GetLat() float32 {
	if x != nil {
		return x.Lat
	}
	return 0
...
func (x *GetLocationResponse_Location) GetLng() float32 {
	if x != nil {
		return x.Lng
	}
	return 0
...
var file_proto_location_proto_rawDesc = []byte{
	...
	0x22, 0x32, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x75, 0x72, 0x69, 0x65,
	0x72, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x63, 0x6f, 0x75, 0x72, 0x69,
	0x65, 0x72, 0x49, 0x64, 0x22, 0x45, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x1a, 0x2e, 0x0a, 0x08, 0x4c,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x6c, 0x6e, 0x67, 0x32, 0x58, 0x0a, 0x08, 0x4c,
	0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4c, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x4c, 0x6f,
...
var file_proto_location_proto_goTypes = []interface{}{
	...
	(*GetLocationResponse_Location)(nil), // 2: location.GetLocationResponse.Location
}
var file_proto_location_proto_depIdxs = []int32{
	0, // 0: location.Location.GetLocation:input_type -> location.GetLocationRequest
	1, // 1: location.Location.GetLocation:output_type -> location.GetLocationResponse
...
func file_proto_location_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_location_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLocationResponse_Location); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
